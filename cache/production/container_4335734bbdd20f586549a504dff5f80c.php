...
class phpbb_cache_container extends \Symfony\Component\DependencyInjection\Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = [
            ...
            'david63.bulkuseradd.acp.manage.controller' => 'getDavid63_Bulkuseradd_Acp_Manage_ControllerService',
            'david63.bulkuseradd.acp.upload.controller' => 'getDavid63_Bulkuseradd_Acp_Upload_ControllerService',
            'david63.bulkuseradd.classes.read_filter' => 'getDavid63_Bulkuseradd_Classes_ReadFilterService',
            'david63.bulkuseradd.core.functions' => 'getDavid63_Bulkuseradd_Core_FunctionsService',
            'david63.bulkuseradd.listener' => 'getDavid63_Bulkuseradd_ListenerService',
        ...
        $this->privates = [
            ...
            'david63.bulkuseradd.acp.manage.controller' => true,
            'david63.bulkuseradd.acp.upload.controller' => true,
            'david63.bulkuseradd.classes.read_filter' => true,
            'david63.bulkuseradd.core.functions' => true,
            'david63.bulkuseradd.listener' => true,
            'dbal.conn' => true,
            'dbal.conn.driver' => true,
            'dbal.extractor' => true,
            ...
            'profilefields.type.googleplus' => true,
    ...
    {
        return $this->services['config'] = new \phpbb\config\db(${($_ = isset($this->services['dbal.conn']) ? $this->services['dbal.conn'] : ($this->services['dbal.conn'] = new \phpbb\db\driver\factory($this))) && false ?: '_'}, ${($_ = isset($this->services['cache.driver']) ? $this->services['cache.driver'] : ($this->services['cache.driver'] = new \phpbb\cache\driver\file())) && false ?: '_'}, 'tgbb_config');
    }
    ...
    {
        return $this->services['config_text'] = new \phpbb\config\db_text(${($_ = isset($this->services['dbal.conn']) ? $this->services['dbal.conn'] : ($this->services['dbal.conn'] = new \phpbb\db\driver\factory($this))) && false ?: '_'}, 'tgbb_config_text');
    }
    ...
    {
        return $this->services['content.visibility'] = new \phpbb\content_visibility(${($_ = isset($this->services['auth']) ? $this->services['auth'] : ($this->services['auth'] = new \phpbb\auth\auth())) && false ?: '_'}, ${($_ = isset($this->services['config']) ? $this->services['config'] : $this->getConfigService()) && false ?: '_'}, ${($_ = isset($this->services['dispatcher']) ? $this->services['dispatcher'] : $this->getDispatcherService()) && false ?: '_'}, ${($_ = isset($this->services['dbal.conn']) ? $this->services['dbal.conn'] : ($this->services['dbal.conn'] = new \phpbb\db\driver\factory($this))) && false ?: '_'}, ${($_ = isset($this->services['user']) ? $this->services['user'] : $this->getUserService()) && false ?: '_'}, './', 'php', 'tgbb_forums', 'tgbb_posts', 'tgbb_topics', 'tgbb_users');
    }
    ...
    {
        $instance = new \phpbb\captcha\plugins\qa('tgbb_captcha_questions', 'tgbb_captcha_answers', 'tgbb_qa_confirm');
    ...
    /**
     * Gets the private 'david63.bulkuseradd.acp.manage.controller' shared service.
     *
     * @return \david63\bulkuseradd\controller\acp_manage_controller
     */
    protected function getDavid63_Bulkuseradd_Acp_Manage_ControllerService()
    {
        return $this->services['david63.bulkuseradd.acp.manage.controller'] = new \david63\bulkuseradd\controller\acp_manage_controller(${($_ = isset($this->services['config']) ? $this->services['config'] : $this->getConfigService()) && false ?: '_'}, ${($_ = isset($this->services['request']) ? $this->services['request'] : ($this->services['request'] = new \phpbb\request\request(NULL, true))) && false ?: '_'}, ${($_ = isset($this->services['template']) ? $this->services['template'] : $this->getTemplateService()) && false ?: '_'}, ${($_ = isset($this->services['user']) ? $this->services['user'] : $this->getUserService()) && false ?: '_'}, ${($_ = isset($this->services['log']) ? $this->services['log'] : $this->getLogService()) && false ?: '_'}, ${($_ = isset($this->services['language']) ? $this->services['language'] : $this->getLanguageService()) && false ?: '_'}, ${($_ = isset($this->services['david63.bulkuseradd.core.functions']) ? $this->services['david63.bulkuseradd.core.functions'] : $this->getDavid63_Bulkuseradd_Core_FunctionsService()) && false ?: '_'});
    }

    /**
     * Gets the private 'david63.bulkuseradd.acp.upload.controller' shared service.
     *
     * @return \david63\bulkuseradd\controller\acp_upload_controller
     */
    protected function getDavid63_Bulkuseradd_Acp_Upload_ControllerService()
    {
        return $this->services['david63.bulkuseradd.acp.upload.controller'] = new \david63\bulkuseradd\controller\acp_upload_controller(${($_ = isset($this->services['config']) ? $this->services['config'] : $this->getConfigService()) && false ?: '_'}, ${($_ = isset($this->services['cache']) ? $this->services['cache'] : $this->getCacheService()) && false ?: '_'}, ${($_ = isset($this->services['request']) ? $this->services['request'] : ($this->services['request'] = new \phpbb\request\request(NULL, true))) && false ?: '_'}, ${($_ = isset($this->services['template']) ? $this->services['template'] : $this->getTemplateService()) && false ?: '_'}, ${($_ = isset($this->services['user']) ? $this->services['user'] : $this->getUserService()) && false ?: '_'}, ${($_ = isset($this->services['log']) ? $this->services['log'] : $this->getLogService()) && false ?: '_'}, ${($_ = isset($this->services['language']) ? $this->services['language'] : $this->getLanguageService()) && false ?: '_'}, ${($_ = isset($this->services['dbal.conn']) ? $this->services['dbal.conn'] : ($this->services['dbal.conn'] = new \phpbb\db\driver\factory($this))) && false ?: '_'}, './', 'php', ${($_ = isset($this->services['passwords.manager']) ? $this->services['passwords.manager'] : $this->getPasswords_ManagerService()) && false ?: '_'}, ${($_ = isset($this->services['files.factory']) ? $this->services['files.factory'] : ($this->services['files.factory'] = new \phpbb\files\factory($this))) && false ?: '_'}, ${($_ = isset($this->services['david63.bulkuseradd.classes.read_filter']) ? $this->services['david63.bulkuseradd.classes.read_filter'] : ($this->services['david63.bulkuseradd.classes.read_filter'] = new \david63\bulkuseradd\classes\read_filter(0, 0, []))) && false ?: '_'}, ${($_ = isset($this->services['david63.bulkuseradd.core.functions']) ? $this->services['david63.bulkuseradd.core.functions'] : $this->getDavid63_Bulkuseradd_Core_FunctionsService()) && false ?: '_'}, $this->parameters['tables']);
    }

    /**
     * Gets the private 'david63.bulkuseradd.classes.read_filter' shared service.
     *
     * @return \david63\bulkuseradd\classes\read_filter
     */
    protected function getDavid63_Bulkuseradd_Classes_ReadFilterService()
    {
        return $this->services['david63.bulkuseradd.classes.read_filter'] = new \david63\bulkuseradd\classes\read_filter(0, 0, []);
    }

    /**
     * Gets the private 'david63.bulkuseradd.core.functions' shared service.
     *
     * @return \david63\bulkuseradd\core\functions
     */
    protected function getDavid63_Bulkuseradd_Core_FunctionsService()
    {
        return $this->services['david63.bulkuseradd.core.functions'] = new \david63\bulkuseradd\core\functions(${($_ = isset($this->services['ext.manager']) ? $this->services['ext.manager'] : $this->getExt_ManagerService()) && false ?: '_'});
    }

    /**
     * Gets the private 'david63.bulkuseradd.listener' shared service.
     *
     * @return \david63\bulkuseradd\event\listener
     */
    protected function getDavid63_Bulkuseradd_ListenerService()
    {
        return $this->services['david63.bulkuseradd.listener'] = new \david63\bulkuseradd\event\listener(${($_ = isset($this->services['dbal.conn']) ? $this->services['dbal.conn'] : ($this->services['dbal.conn'] = new \phpbb\db\driver\factory($this))) && false ?: '_'}, './', 'php', $this->parameters['tables']);
    }
    ...
    protected function getDispatcherService()
    {
        ...
        $instance->addListener('core.session_create_after', [0 => function () {
            return ${($_ = isset($this->services['david63.bulkuseradd.listener']) ? $this->services['david63.bulkuseradd.listener'] : $this->getDavid63_Bulkuseradd_ListenerService()) && false ?: '_'};
        }, 1 => 'update_password'], 0);
        $instance->addListener('core.update_session_after', [0 => function () {
            return ${($_ = isset($this->services['david63.bulkuseradd.listener']) ? $this->services['david63.bulkuseradd.listener'] : $this->getDavid63_Bulkuseradd_ListenerService()) && false ?: '_'};
        }, 1 => 'check_password'], 0);
        $instance->addListener('core.ucp_profile_reg_details_sql_ary', [0 => function () {
            return ${($_ = isset($this->services['david63.bulkuseradd.listener']) ? $this->services['david63.bulkuseradd.listener'] : $this->getDavid63_Bulkuseradd_ListenerService()) && false ?: '_'};
        }, 1 => 'update_user_setting'], 0);
    ...
    {
        return $this->services['ext.manager'] = new \phpbb\extension\manager($this, ${($_ = isset($this->services['dbal.conn']) ? $this->services['dbal.conn'] : ($this->services['dbal.conn'] = new \phpbb\db\driver\factory($this))) && false ?: '_'}, ${($_ = isset($this->services['config']) ? $this->services['config'] : $this->getConfigService()) && false ?: '_'}, ${($_ = isset($this->services['filesystem']) ? $this->services['filesystem'] : ($this->services['filesystem'] = new \phpbb\filesystem\filesystem())) && false ?: '_'}, 'tgbb_ext', './', 'php', ${($_ = isset($this->services['cache']) ? $this->services['cache'] : $this->getCacheService()) && false ?: '_'});
    }
    ...
    {
        return new \phpbb\notification\method\email(${($_ = isset($this->services['user_loader']) ? $this->services['user_loader'] : $this->getUserLoaderService()) && false ?: '_'}, ${($_ = isset($this->services['user']) ? $this->services['user'] : $this->getUserService()) && false ?: '_'}, ${($_ = isset($this->services['config']) ? $this->services['config'] : $this->getConfigService()) && false ?: '_'}, './', 'php');
    }
    ...
    {
        $instance = new \phpbb\notification\type\admin_activate_user(${($_ = isset($this->services['dbal.conn']) ? $this->services['dbal.conn'] : ($this->services['dbal.conn'] = new \phpbb\db\driver\factory($this))) && false ?: '_'}, ${($_ = isset($this->services['language']) ? $this->services['language'] : $this->getLanguageService()) && false ?: '_'}, ${($_ = isset($this->services['user']) ? $this->services['user'] : $this->getUserService()) && false ?: '_'}, ${($_ = isset($this->services['auth']) ? $this->services['auth'] : ($this->services['auth'] = new \phpbb\auth\auth())) && false ?: '_'}, './', 'php', 'tgbb_user_notifications');
    ...
    {
        return $this->services['passwords.driver.argon2i'] = new \phpbb\passwords\driver\argon2i(${($_ = isset($this->services['config']) ? $this->services['config'] : $this->getConfigService()) && false ?: '_'}, ${($_ = isset($this->services['passwords.driver_helper']) ? $this->services['passwords.driver_helper'] : $this->getPasswords_DriverHelperService()) && false ?: '_'}, 1024, 2, 2);
    }
    ...
    {
        return $this->services['profilefields.lang_helper'] = new \phpbb\profilefields\lang_helper(${($_ = isset($this->services['dbal.conn']) ? $this->services['dbal.conn'] : ($this->services['dbal.conn'] = new \phpbb\db\driver\factory($this))) && false ?: '_'}, 'tgbb_profile_fields_lang');
    }
    ...
    {
        return $this->services['text_formatter.data_access'] = new \phpbb\textformatter\data_access(${($_ = isset($this->services['dbal.conn']) ? $this->services['dbal.conn'] : ($this->services['dbal.conn'] = new \phpbb\db\driver\factory($this))) && false ?: '_'}, 'tgbb_bbcodes', 'tgbb_smilies', 'tgbb_styles', 'tgbb_words', './styles/');
    }
    ...
    {
        $this->services['text_reparser.forum_description'] = $instance = new \phpbb\textreparser\plugins\forum_description(${($_ = isset($this->services['dbal.conn']) ? $this->services['dbal.conn'] : ($this->services['dbal.conn'] = new \phpbb\db\driver\factory($this))) && false ?: '_'}, 'tgbb_forums');
    ...
    {
        $this->services['text_reparser.forum_rules'] = $instance = new \phpbb\textreparser\plugins\forum_rules(${($_ = isset($this->services['dbal.conn']) ? $this->services['dbal.conn'] : ($this->services['dbal.conn'] = new \phpbb\db\driver\factory($this))) && false ?: '_'}, 'tgbb_forums');
    ...
    {
        $this->services['text_reparser.group_description'] = $instance = new \phpbb\textreparser\plugins\group_description(${($_ = isset($this->services['dbal.conn']) ? $this->services['dbal.conn'] : ($this->services['dbal.conn'] = new \phpbb\db\driver\factory($this))) && false ?: '_'}, 'tgbb_groups');
    ...
    {
        $this->services['text_reparser.pm_text'] = $instance = new \phpbb\textreparser\plugins\pm_text(${($_ = isset($this->services['dbal.conn']) ? $this->services['dbal.conn'] : ($this->services['dbal.conn'] = new \phpbb\db\driver\factory($this))) && false ?: '_'}, 'tgbb_privmsgs');
    ...
    {
        $this->services['text_reparser.poll_option'] = $instance = new \phpbb\textreparser\plugins\poll_option(${($_ = isset($this->services['dbal.conn']) ? $this->services['dbal.conn'] : ($this->services['dbal.conn'] = new \phpbb\db\driver\factory($this))) && false ?: '_'});
    ...
    {
        $this->services['text_reparser.poll_title'] = $instance = new \phpbb\textreparser\plugins\poll_title(${($_ = isset($this->services['dbal.conn']) ? $this->services['dbal.conn'] : ($this->services['dbal.conn'] = new \phpbb\db\driver\factory($this))) && false ?: '_'}, 'tgbb_topics');
    ...
    {
        $this->services['text_reparser.post_text'] = $instance = new \phpbb\textreparser\plugins\post_text(${($_ = isset($this->services['dbal.conn']) ? $this->services['dbal.conn'] : ($this->services['dbal.conn'] = new \phpbb\db\driver\factory($this))) && false ?: '_'}, 'tgbb_posts');
    ...
    {
        $this->services['text_reparser.user_signature'] = $instance = new \phpbb\textreparser\plugins\user_signature(${($_ = isset($this->services['dbal.conn']) ? $this->services['dbal.conn'] : ($this->services['dbal.conn'] = new \phpbb\db\driver\factory($this))) && false ?: '_'}, 'tgbb_users');
    ...
    {
        return $this->services['user_loader'] = new \phpbb\user_loader(${($_ = isset($this->services['dbal.conn']) ? $this->services['dbal.conn'] : ($this->services['dbal.conn'] = new \phpbb\db\driver\factory($this))) && false ?: '_'}, './', 'php', 'tgbb_users');
    }
    ...
    protected function getDefaultParameters()
    {
        return [
            ...
            'tables.acl_groups' => 'tgbb_acl_groups',
            'tables.acl_options' => 'tgbb_acl_options',
            'tables.acl_roles' => 'tgbb_acl_roles',
            'tables.acl_roles_data' => 'tgbb_acl_roles_data',
            'tables.acl_users' => 'tgbb_acl_users',
            'tables.attachments' => 'tgbb_attachments',
            'tables.auth_provider_oauth_token_storage' => 'tgbb_oauth_tokens',
            'tables.auth_provider_oauth_states' => 'tgbb_oauth_states',
            'tables.auth_provider_oauth_account_assoc' => 'tgbb_oauth_accounts',
            'tables.banlist' => 'tgbb_banlist',
            'tables.bbcodes' => 'tgbb_bbcodes',
            'tables.bookmarks' => 'tgbb_bookmarks',
            'tables.bots' => 'tgbb_bots',
            'tables.captcha_qa_questions' => 'tgbb_captcha_questions',
            'tables.captcha_qa_answers' => 'tgbb_captcha_answers',
            'tables.captcha_qa_confirm' => 'tgbb_qa_confirm',
            'tables.config' => 'tgbb_config',
            'tables.config_text' => 'tgbb_config_text',
            'tables.confirm' => 'tgbb_confirm',
            'tables.disallow' => 'tgbb_disallow',
            'tables.drafts' => 'tgbb_drafts',
            'tables.ext' => 'tgbb_ext',
            'tables.extensions' => 'tgbb_extensions',
            'tables.extension_groups' => 'tgbb_extension_groups',
            'tables.forums' => 'tgbb_forums',
            'tables.forums_access' => 'tgbb_forums_access',
            'tables.forums_track' => 'tgbb_forums_track',
            'tables.forums_watch' => 'tgbb_forums_watch',
            'tables.groups' => 'tgbb_groups',
            'tables.icons' => 'tgbb_icons',
            'tables.lang' => 'tgbb_lang',
            'tables.log' => 'tgbb_log',
            'tables.login_attempts' => 'tgbb_login_attempts',
            'tables.migrations' => 'tgbb_migrations',
            'tables.moderator_cache' => 'tgbb_moderator_cache',
            'tables.modules' => 'tgbb_modules',
            'tables.notification_types' => 'tgbb_notification_types',
            'tables.notifications' => 'tgbb_notifications',
            'tables.poll_options' => 'tgbb_poll_options',
            'tables.poll_votes' => 'tgbb_poll_votes',
            'tables.posts' => 'tgbb_posts',
            'tables.privmsgs' => 'tgbb_privmsgs',
            'tables.privmsgs_folder' => 'tgbb_privmsgs_folder',
            'tables.privmsgs_rules' => 'tgbb_privmsgs_rules',
            'tables.privmsgs_to' => 'tgbb_privmsgs_to',
            'tables.profile_fields' => 'tgbb_profile_fields',
            'tables.profile_fields_data' => 'tgbb_profile_fields_data',
            'tables.profile_fields_options_language' => 'tgbb_profile_fields_lang',
            'tables.profile_fields_language' => 'tgbb_profile_lang',
            'tables.ranks' => 'tgbb_ranks',
            'tables.reports' => 'tgbb_reports',
            'tables.reports_reasons' => 'tgbb_reports_reasons',
            'tables.search_results' => 'tgbb_search_results',
            'tables.search_wordlist' => 'tgbb_search_wordlist',
            'tables.search_wordmatch' => 'tgbb_search_wordmatch',
            'tables.sessions' => 'tgbb_sessions',
            'tables.sessions_keys' => 'tgbb_sessions_keys',
            'tables.sitelist' => 'tgbb_sitelist',
            'tables.smilies' => 'tgbb_smilies',
            'tables.sphinx' => 'tgbb_sphinx',
            'tables.styles' => 'tgbb_styles',
            'tables.styles_template' => 'tgbb_styles_template',
            'tables.styles_template_data' => 'tgbb_styles_template_data',
            'tables.styles_theme' => 'tgbb_styles_theme',
            'tables.styles_imageset' => 'tgbb_styles_imageset',
            'tables.styles_imageset_data' => 'tgbb_styles_imageset_data',
            'tables.teampage' => 'tgbb_teampage',
            'tables.topics' => 'tgbb_topics',
            'tables.topics_posted' => 'tgbb_topics_posted',
            'tables.topics_track' => 'tgbb_topics_track',
            'tables.topics_watch' => 'tgbb_topics_watch',
            'tables.user_group' => 'tgbb_user_group',
            'tables.user_notifications' => 'tgbb_user_notifications',
            'tables.users' => 'tgbb_users',
            'tables.warnings' => 'tgbb_warnings',
            'tables.words' => 'tgbb_words',
            'tables.zebra' => 'tgbb_zebra',
            ...
            'tables' => [
                'acl_groups' => 'tgbb_acl_groups',
                'acl_options' => 'tgbb_acl_options',
                'acl_roles' => 'tgbb_acl_roles',
                'acl_roles_data' => 'tgbb_acl_roles_data',
                'acl_users' => 'tgbb_acl_users',
                'attachments' => 'tgbb_attachments',
                'auth_provider_oauth_token_storage' => 'tgbb_oauth_tokens',
                'auth_provider_oauth_states' => 'tgbb_oauth_states',
                'auth_provider_oauth_account_assoc' => 'tgbb_oauth_accounts',
                'banlist' => 'tgbb_banlist',
                'bbcodes' => 'tgbb_bbcodes',
                'bookmarks' => 'tgbb_bookmarks',
                'bots' => 'tgbb_bots',
                'captcha_qa_questions' => 'tgbb_captcha_questions',
                'captcha_qa_answers' => 'tgbb_captcha_answers',
                'captcha_qa_confirm' => 'tgbb_qa_confirm',
                'config' => 'tgbb_config',
                'config_text' => 'tgbb_config_text',
                'confirm' => 'tgbb_confirm',
                'disallow' => 'tgbb_disallow',
                'drafts' => 'tgbb_drafts',
                'ext' => 'tgbb_ext',
                'extensions' => 'tgbb_extensions',
                'extension_groups' => 'tgbb_extension_groups',
                'forums' => 'tgbb_forums',
                'forums_access' => 'tgbb_forums_access',
                'forums_track' => 'tgbb_forums_track',
                'forums_watch' => 'tgbb_forums_watch',
                'groups' => 'tgbb_groups',
                'icons' => 'tgbb_icons',
                'lang' => 'tgbb_lang',
                'log' => 'tgbb_log',
                'login_attempts' => 'tgbb_login_attempts',
                'migrations' => 'tgbb_migrations',
                'moderator_cache' => 'tgbb_moderator_cache',
                'modules' => 'tgbb_modules',
                'notification_types' => 'tgbb_notification_types',
                'notifications' => 'tgbb_notifications',
                'poll_options' => 'tgbb_poll_options',
                'poll_votes' => 'tgbb_poll_votes',
                'posts' => 'tgbb_posts',
                'privmsgs' => 'tgbb_privmsgs',
                'privmsgs_folder' => 'tgbb_privmsgs_folder',
                'privmsgs_rules' => 'tgbb_privmsgs_rules',
                'privmsgs_to' => 'tgbb_privmsgs_to',
                'profile_fields' => 'tgbb_profile_fields',
                'profile_fields_data' => 'tgbb_profile_fields_data',
                'profile_fields_options_language' => 'tgbb_profile_fields_lang',
                'profile_fields_language' => 'tgbb_profile_lang',
                'ranks' => 'tgbb_ranks',
                'reports' => 'tgbb_reports',
                'reports_reasons' => 'tgbb_reports_reasons',
                'search_results' => 'tgbb_search_results',
                'search_wordlist' => 'tgbb_search_wordlist',
                'search_wordmatch' => 'tgbb_search_wordmatch',
                'sessions' => 'tgbb_sessions',
                'sessions_keys' => 'tgbb_sessions_keys',
                'sitelist' => 'tgbb_sitelist',
                'smilies' => 'tgbb_smilies',
                'sphinx' => 'tgbb_sphinx',
                'styles' => 'tgbb_styles',
                'styles_template' => 'tgbb_styles_template',
                'styles_template_data' => 'tgbb_styles_template_data',
                'styles_theme' => 'tgbb_styles_theme',
                'styles_imageset' => 'tgbb_styles_imageset',
                'styles_imageset_data' => 'tgbb_styles_imageset_data',
                'teampage' => 'tgbb_teampage',
                'topics' => 'tgbb_topics',
                'topics_posted' => 'tgbb_topics_posted',
                'topics_track' => 'tgbb_topics_track',
                'topics_watch' => 'tgbb_topics_watch',
                'user_group' => 'tgbb_user_group',
                'user_notifications' => 'tgbb_user_notifications',
                'users' => 'tgbb_users',
                'warnings' => 'tgbb_warnings',
                'words' => 'tgbb_words',
                'zebra' => 'tgbb_zebra',
            ],
            'core.adm_relative_path' => 'adm/',
            'core.table_prefix' => 'tgbb_',
